        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PendingIconColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PendingBackgroundColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    AcceptedIconColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    AcceptedBackgroundColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModify = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    DateOfFoundation = table.Column<DateOnly>(type: "date", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    LocalName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusOfType = table.Column<int>(type: "int", nullable: false),
                    StatusOfDates = table.Column<int>(type: "int", nullable: false),
                    IsFullyConfirmed = table.Column<int>(type: "int", nullable: false),
                    Reason = table.Column<string>(type: "nvarchar(360)", maxLength: 360, nullable: true),
                    EndDate = table.Column<DateOnly>(type: "date", nullable: false),
                    StartDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDeletedId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserCards_AspNetUsers_UserDeletedId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserCards_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    IsStrangeActivity = table.Column<bool>(type: "bit", nullable: false),
                    StrangeActivityReason = table.Column<string>(type: "nvarchar(360)", maxLength: 360, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_AspNetUsers_ResolvedById",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Attendances_UserCards_UserCardId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_ResolvedById",
                table: "Attendances",
                column: "ResolvedById");

            migrationBuilder.CreateIndex(
                name: "IX_Attendances_UserCardId",
                table: "Attendances",
                column: "UserCardId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCards_CompanyId",
                table: "UserCards",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCards_UserDeletedId",
                table: "UserCards",
