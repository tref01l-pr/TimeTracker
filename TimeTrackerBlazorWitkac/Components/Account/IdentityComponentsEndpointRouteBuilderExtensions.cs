...
using TimeTrackerBlazorWitkac.Components.Account.Pages;
using TimeTrackerBlazorWitkac.Components.Account.Pages.Manage;
...
namespace Microsoft.AspNetCore.Routing
{
    internal static class IdentityComponentsEndpointRouteBuilderExtensions
    {
        ...
        public static IEndpointConventionBuilder MapAdditionalIdentityEndpoints(this IEndpointRouteBuilder endpoints)
        {
            ...
            accountGroup.MapPost("/Logout", async Task<IResult> (
                ClaimsPrincipal user,
                IAuthorizationService authorizationService,
                [FromForm] string returnUrl) =>
            {
                var result = await authorizationService.SignOut();
                if (result.IsFailure)
                {
